...
public class ControllerExceptionHandler {
  ...
  public ResponseEntity<ApiError> noHandlerFoundException(HttpServletRequest req,
  ...
  public ResponseEntity<ApiError> handlerHttpRequestMethodNotSupportedException(
  ...
  public ResponseEntity<ApiError> handlerHttpMessageNotReadableException(HttpServletRequest req,
  ...
  public ResponseEntity<ApiError> handleMissingRequestParameterException(
