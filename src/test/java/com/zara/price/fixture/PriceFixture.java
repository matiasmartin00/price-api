...
public class PriceFixture {
  ...
  public static com.zara.price.controller.dto.Price price(Brand brand, Long productId,
      Long priceList, ZonedDateTime start, ZonedDateTime end, BigDecimal price) {
    return com.zara.price.controller.dto.Price.builder()
        .productId(productId)
        .brand(brand)
        .priceList(priceList)
